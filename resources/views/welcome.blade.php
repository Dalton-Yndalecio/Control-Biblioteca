...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading text-primary">Hola, Bienvenido a</div>
                <div class="masthead-heading text-primary">I.E. César A. Vallejo M.</div>
                <div class="masthead-heading text-primary">Nivel Secundario</div>
            </div>
        </header>
        {{--  <!-- Services-->
